...
func _ready() -> void:
	...
	size_flags_horizontal = Control.SIZE_FILL  # Button nimmt den verfügbaren horizontalen Platz ein
	size_flags_vertical = Control.SIZE_SHRINK_CENTER  # Der Button schrumpft vertikal, falls nötig
